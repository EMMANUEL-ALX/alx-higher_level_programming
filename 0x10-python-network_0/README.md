...
At my networking project, I emplored `curl` with Bash scripts to send various types
of HTTP headers. In the process, i ensured i learned about how URL's work, domain names,
the vast  HTTP request/repsonse header fields and status codes, and
how to emplore cookies.

My project on number `:6` was an arithmetical tussle contrary from the general project title
completed in Python.


## Tasks :page_with_curl:

Cogently: The `curl` behavior in all Bash scripts were written to interact with a
